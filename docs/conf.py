...
project = u'zaffy'
copyright = u'2013-2014, tomoemon'
...
#release = version + "." + datetime.datetime.now().strftime("%Y-%m-%d")
release = version
...
latex_documents = [
  ('index', 'zaffy.tex', u'zaffy Documentation',
   u'tomoemon', 'manual'),
]
...
man_pages = [
    ('index', 'zaffy', u'zaffy Documentation',
     [u'tomoemon'], 1)
]
...
texinfo_documents = [
  ('index', 'zaffy', u'zaffy Documentation',
   u'tomoemon', 'zaffy', 'One line description of project.',
   'Miscellaneous'),
]
...
.. automodule:: {4}.{2}
'''.format(title_bar, title, module, stripped, target_module_dir).encode('utf-8'))

create_module_doc("customfilters", "filter")
create_module_doc("customtests", "test")
